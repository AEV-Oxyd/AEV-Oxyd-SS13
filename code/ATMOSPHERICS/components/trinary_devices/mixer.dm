...
/obj/machinery/atmospherics/trinary/mixer/Initialize(mapload, d)
	. = ..()
...
obj/machinery/atmospherics/trinary/mixer/t_mixer/Initialize(mapload, d)
	. = ..()
	switch(dir)
		if(NORTH)
...
obj/machinery/atmospherics/trinary/mixer/m_mixer/Initialize(mapload, d)
	. = ..()
	switch(dir)
		if(NORTH)
			initialize_directions = WEST|NORTH|SOUTH
