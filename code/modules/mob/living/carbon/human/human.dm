/mob/living/carbon/human
	...
	/// everyone is 65 KGs
	weight = 65000
	hitbox = /datum/hitboxDatum/human
...
/datum/hitboxDatum/human
	boundingBoxes = list(
		"0" = list(
			LISTNORTH = list(
				...
				BBOX(13,23,19,28, LEVEL_CHEST, LEVEL_STANDING, HB_HEAD) // HEAD
			),
			LISTSOUTH = list(
				BBOX(11,1,21,8,LEVEL_TURF, LEVEL_TABLE, HB_LEGS), // LEGS
				BBOX(11,9,21,11,LEVEL_TABLE, LEVEL_GROIN, HB_GROIN), // GROIN
			...
			LISTEAST = list(
				...
				BBOX(13,12,20,28, LEVEL_CHEST, LEVEL_STANDING, HB_HEAD) // HEAD
			),
			LISTWEST = list(
				BBOX(14,1,19,9, LEVEL_TURF, LEVEL_TABLE, HB_LEGS), // LEGS
				BBOX(14,10,21,12, LEVEL_TABLE,  LEVEL_GROIN, HB_GROIN), // GROIN
		...
		"1" = list(
			LISTNORTH = list(
				...
				BBOX(23,14,28,20, LEVE_TURF + 0.3, LEVEL_LYING, HB_HEAD)
			),
			LISTSOUTH = list(
				BBOX(1,11,9,23, LEVEL_TURF, LEVEL_TURF + 0.1, HB_LEGS),
				BBOX(9,12,11,22, LEVEL_TURF + 0.1, LEVEL_TURF + 0.2, HB_GROIN),
			...
			LISTEAST = list(
				...
				BBOX(24,13,29,20, LEVEL_TURF + 0.3, LEVEL_LYING, HB_HEAD)
			),
			LISTWEST = list(
				BBOX(1,14,10,19, LEVEL_TURF, LEVEL_TURF + 0.1, HB_LEGS),
				BBOX(9,14,12,20, LEVEL_TURF + 0.1, LEVEL_TURF + 0.2 , HB_GROIN),
	...
	defZoneToLevel = list(
		"0" = list(
			BP_EYES = (LEVEL_STANDING + LEVEL_CHEST)/2,
			BP_MOUTH = (LEVEL_STANDING + LEVEL_CHEST)/2,
			BP_HEAD = (LEVEL_STANDING + LEVEL_CHEST)/2,
		...
		"1" = list(
			BP_EYES = (LEVEL_TURF + 0.3 + LEVEL_LYING)/2,
			BP_MOUTH = (LEVEL_TURF + 0.3 + LEVEL_LYING)/2,
			BP_HEAD = (LEVEL_TURF + 0.3 + LEVEL_LYING)/2,
